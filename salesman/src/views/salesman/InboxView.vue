<template>
  <div class="overflow-hidden">
    ...
    <nav
      class="flex md:-mt-10 md:justify-center justify-between px-5 md:py-5 py-1 md:px-12 items-center rounded-b-2xl shadow-lg bg-gray-400"
    >
      <div>
        <form>
          <div class="relative">
            <label
              for="search"
              class="absolute text-2xl rounded-l-full z-10 border-r-2 inset-y-0 left-0 flex items-center p-3 cursor-pointer"
            >
      ...
      <div class="px-12 pt-5 lg:max-w-[700px] items-center w-full flex justify-between">
        <div class="flex gap-12">
          ...
          <div>
            <p>
              <i
                class="bx bx-refresh cursor-pointer text-2xl p-2 active:bg-gray-500 active:shadow-xl active:border py-1 rounded-lg bg-gray-400"
              ></i>
            </p>
          </div>
        </div>
    ...
    <div class="flex justify-between md:px-12">
      ...
      >
        ...
        <button @click="cog = !cog" class="lg:hidden float-right mt-2 py-1 px-5 rounded  bg-blue-600">close</button>
      </div>
    </div>

    <div class="flex items-center lg:px-12 lg:justify-start justify-center py-3">
      <p class="mx-2"><span>1</span>-<span>50</span> of <span>234</span></p>
      <p>
        <i
          class="bx bx-chevron-left p-2 cursor-pointer active:bg-gray-500 active:shadow-xl active:border rounded bg-gray-400 mx-1"
        ></i>
        <i
          class="bx bx-chevron-right p-2 cursor-pointer active:bg-gray-500 active:shadow-xl active:border rounded bg-gray-400 mx-1"
        ></i>
      </p>
    </div>
  </div>
